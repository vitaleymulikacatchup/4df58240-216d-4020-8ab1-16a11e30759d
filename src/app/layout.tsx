...
export const metadata: Metadata = {
  title: "F1 Teams Hub - Formula 1 Teams & Racing Coverage",
  description: "Comprehensive Formula 1 teams coverage with driver insights, race analysis, latest news, and exclusive content for passionate F1 fans worldwide.",
  keywords: "Formula 1, F1 teams, racing, drivers, championship, motorsport, race results, F1 news",
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763642488153-beo5y6s1.jpg",
        alt: "Formula 1 racing cars in action"
      }
    ]
  },
  twitter: {
    ...
    title: "F1 Teams Hub - Formula 1 Teams & Racing Coverage",
    description: "Comprehensive Formula 1 teams coverage with driver insights, race analysis, latest news, and exclusive content for passionate F1 fans worldwide.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763642488153-beo5y6s1.jpg"]
  }
};
